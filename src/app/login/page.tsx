...
export default async function LoginPage(props: PageProps<"/login">) {
  ...
  return (
    <main className="min-h-screen grid md:grid-cols-2">
      <section
        className="hidden md:flex flex-col justify-center px-12 lg:px-20 py-32 border-r"
      ...
      >
        ...
        <p className="text-kov-steel mt-8 max-w-sm text-sm leading-relaxed">
          Connexion réservée aux clients et à l&apos;équipe KOV — suivi de projet et échanges centralisés.
        </p>

        <div
          className="mt-12 flex items-start gap-4 border p-4 max-w-sm"
