...
// Vendored from reactbits.dev (DavidHDev/react-bits, Backgrounds/Lightning,
// MIT-licensed) rather than hand-rolled — a raymarched-noise WebGL bolt
// shader, not an interaction/animation pattern reasonable to reimplement
...
export default function Lightning({ hue = 230, xOffset = 0, speed = 1, intensity = 1, size = 1, className = "" }: LightningProps) {
