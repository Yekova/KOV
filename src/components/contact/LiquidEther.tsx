...
// interaction/animation pattern reasonable to reimplement from scratch. Kept
// intentionally close to the upstream source (shaders and simulation classes
// unchanged) since subtle edits to this kind of numerical code risk silently
// breaking the effect in ways that are hard to notice by inspection. `any` is
